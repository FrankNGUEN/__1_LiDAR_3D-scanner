...
img = cv2.imread('images/lidar.JPG', cv2.IMREAD_GRAYSCALE)
cv2.imshow("image from LiDAR", img)
#------------------------------------------------------------------------------
# threshold to binary
...
#------------------------------------------------------------------------------
# write results
cv2.imwrite("images_out/K_thresh.png", thresh)
cv2.imwrite("images_out/K_morph.png", morph)
cv2.imwrite("images_out/K_letter.png", letter)
cv2.imwrite("images_out/K_edges.png", edges)
#------------------------------------------------------------------------------
# show results
